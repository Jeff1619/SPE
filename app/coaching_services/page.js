        ...
        <>
            <div className="conatiner mx-auto">
                <motion.div
                    ...
                    className=" md:bg-fixed bg-[url('../public/coaching/offer.jpg')] bg-cover bg-center">
                    ...
                    <div className="container mx-auto flex justify-center">
                        <div className="space-y-7 md:flex md:flex-wrap md:gap-10 md:mx-10 md:justify-center md:space-y-0">
                            <motion.div
                                ...
                                className=" w-48 h-56 bg-slate-100 rounded-lg shadow-lg shadow-slate-200 ">
                            ...
                            <motion.div
                                initial={{ x: "-10vw", opacity: 0 }}
                                whileInView={{ x: 0, opacity: 1 }}
                                transition={{ delay: 0.8, type: "spring", stiffness: 120, duration: 1 }}
                                className=" w-48 h-56 bg-slate-100 rounded-lg shadow-lg shadow-slate-200 ">
            ...
            <div className="conatiner mx-auto ">
                <div className="bg-yellow-400 overflow-hidden">
                    ...
                    <div className="py-5">
                        <h1
                            className="text-black px-4 text-center font-semibold  md:text-lg space-x-1 md:space-x-4"><motion.span
                                initial={{ opacity: 0 }}
                                whileInView={{ opacity: 1 }}
                                transition={{ duration: 1 }}
                                className="great text-3xl md:text-5xl tracking-widest">Guidance</motion.span> <span>and</span> <motion.span
                                    initial={{ opacity: 0 }}
                                    whileInView={{ opacity: 1 }}
                                    transition={{ duration: 1 }}
                                    className="great text-3xl md:text-5xl tracking-widest">Coaching</motion.span></h1>
                        ...
                        <div className="mt-4 md:mt-5 lg:mt-8">
                            <motion.p
                                ...
                                className="px-4 md:px-0 text-sm md:text-base text-justify md:text-center md:w-1/2 md:mx-auto text-black">
                ...
                <div className="container mx-auto">
                    <div className="py-4">
                        <motion.h1
                            ...
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-xs md:text-lg text-yellow-100">Guidance for <span className="great text-3xl md:text-5xl lg:text-6xl tracking-widest  font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-yellow-400">Children</span></motion.h1>
                        <motion.h1
                            initial={{ x: "-20vw", opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ delay: 0.2, type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-yellow-100">&#40;Ages 6-12&#41;</motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ delay: 0.4, duration: 1 }}
                            className="my-6 text-sm md:text-base md:my-10 text-justify px-5 md:px-0 md:w-2/3 md:text-center md:mx-auto text-yellow-50"><span className="josefin text-lg md:text-xl font-semibold italic">Social Skills Development:</span> Teach children essential social skills, such as communication, empathy, and teamwork, to help them build positive relationships with peers and adults.
                ...
                <div className="container mx-auto">
                    <div className="py-4">
                        <motion.h1
                            ...
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-xs md:text-lg text-yellow-100">Guidance for <span className="great text-3xl md:text-5xl lg:text-6xl tracking-widest  font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-yellow-400">Teens</span></motion.h1>
                        <motion.h1
                            initial={{ x: "-20vw", opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ delay: 0.2, type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-yellow-100">&#40;Ages 13&#45;19&#41;</motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ delay: 0.4, duration: 1 }}
                            className="my-6 text-sm md:text-base md:my-10 text-justify px-5 md:px-0 md:w-2/3 md:text-center md:mx-auto text-yellow-50"><span className="josefin text-lg md:text-xl font-semibold italic">
                ...
                <div className="container mx-auto">
                    <div className="py-4">
                        <motion.h1
                            ...
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-xs md:text-lg text-yellow-100">Guidance for
                            <span className="great text-3xl md:text-5xl lg:text-6xl tracking-widest  font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-yellow-400">Young Adults</span></motion.h1>
                        <motion.h1
                            initial={{ x: "-20vw", opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ delay: 0.2, type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-yellow-100">&#40;Ages 20&#45;30&#41;</motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ delay: 0.2, duration: 1 }}
                ...
                <div className="container mx-auto">
                    <div className="py-4">
                        <motion.h1
                            ...
                            transition={{ type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-xs md:text-lg text-yellow-100">Guidance for
                            <span className="great text-3xl md:text-5xl lg:text-6xl tracking-widest  font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-yellow-400">Adults</span></motion.h1>
                        <motion.h1
                            initial={{ x: "-20vw", opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ delay: 0.2, type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-yellow-100">&#40;Ages 31&#43;&#41;</motion.h1>
                        <motion.p
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ delay: 0.4, duration: 1 }}
                            className="my-6 text-sm md:text-base md:my-10 text-justify px-5 md:px-0 md:w-2/3 md:text-center md:mx-auto text-yellow-50"><span className="josefin text-lg md:text-xl font-semibold italic">Career Advancement&#58;</span> Offer strategies for career growth&#44; leadership development&#44; and achieving professional goals&#46;
                ...
                <div className="container mx-auto">
                    <div className="py-4">
                        <motion.h1
                            ...
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ delay: 0.2, type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-xs md:text-lg text-yellow-100 space-x-3 md:space-x-5">
                            <span className="great text-3xl md:text-5xl lg:text-6xl tracking-widest  font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-yellow-400">Family</span><span>and</span><span className="great text-3xl md:text-5xl lg:text-6xl tracking-widest  font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-100 to-yellow-400 ">Parent</span></motion.h1>
                        <motion.h1
                            initial={{ x: "-20vw", opacity: 0 }}
                            whileInView={{ x: 0, opacity: 1 }}
                            transition={{ delay: 0.4, type: "spring", stiffness: 120, duration: 1 }}
                            className="text-center font-sans font-medium text-xs md:text-lg text-yellow-100 mb-2">Coaching</motion.h1>

                        <motion.p
                            initial={{ opacity: 0 }}
                            whileInView={{ opacity: 1 }}
                            transition={{ delay: 0.6, duration: 1 }}
                            className="my-6 md:my-10 text-sm md:text-base text-justify px-5 md:px-0 md:w-2/3 md:text-center md:mx-auto text-yellow-50">
