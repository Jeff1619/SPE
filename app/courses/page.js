    ...
    return (
        ...
        <>
            <motion.section
                ...
                className="bg-cover bg-center bg-[url('../public/objectives/banner.jpg')] w-full h-44 sm:h-72 md:h-60">
                <div

                    className="bg-gradient-to-r w-full h-44 sm:h-72 md:h-60 from-black/70 to-black/40">
            ...
            <div className="mx-4 sm:mx-8 my-5 sm:my-8">
                <div className="md:flex md:justify-center md:mb-10 md:gap-7">
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.3, duration: 1 }}
                        className="md:w-1/2 mb-7 md:mb-0">
                        <div className="border border-yellow-100 rounded-lg">
                            ...
                            <p className="text-justify p-3 sm:p-5 italic md:mb-6 lg:mb-0  md:text-base">Facilitating opportunities for students to gain meaningful employment&#44; internships&#44; or career development support&#46;</p>
                            <div>
                    ...
                    <motion.div
                        ...
                        <div className=" border border-yellow-100 rounded-lg">
                            ...
                            <p className="text-justify p-3 sm:p-5 italic   md:text-base">Providing resources&#44; mentorship&#44; or programs that help individuals bounce back from setbacks&#44; failures&#44; or challenges in their academic or personal lives&#46;</p>
                            <div>
                ...
                <div className="md:w-3/5 md:mx-auto mb-7 md:mb-0">
                    <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        transition={{ delay: 0.3, duration: 1 }}
                        className=" border border-yellow-100 rounded-lg">
                        ...
                        <p className="text-justify p-3 sm:p-5 italic  md:text-base">Equipping individuals with the skills&#44; knowledge&#44; and support needed to achieve financial stability and independence&#44; possibly through financial literacy programs&#44; job readiness training&#44; or entrepreneurship initiatives&#46;</p>
                        <div>
